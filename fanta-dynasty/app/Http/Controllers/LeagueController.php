...
use App\Models\{League, LeagueParticipant, Roster, RealPlayer, User, MarketSession, MarketValueHistory};
...
class LeagueController extends Controller
{
    public function dashboard()
    {
        ...
        if ($firstLeague) {
            ...
            // 2. CALCOLI FINANZIARI PER I NUOVI RIQUADRI
            ...
            // Dati Utente per Valore e Probabilità
        ...
        // QUESTA PARTE MANCAVA NEL TUO CODICE: chiude la funzione e invia i dati
    ...
    public function updateCampionato(Request $request) 
    {
        ...
        // Ricalcola Valori per tutti i grafici
