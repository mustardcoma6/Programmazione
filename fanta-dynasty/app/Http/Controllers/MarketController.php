...
{
    // ... [myRosterPage, auctions, buy, release, updateContract, history rimangono uguali] ...
    ...
    public function storeSession(Request $request) {
        ...
        $request->validate([
            ...
            'start_at.required' => 'Devi inserire una data di inizio.',
            'end_at.required' => 'Devi inserire una data di fine.',
            'end_at.after' => 'La data di fine deve essere successiva a quella di inizio!',
        ]);
        ...
        return back()->with('message', 'Sessione programmata con successo!');
    }
    ...
    // [Funzioni di servizio obbligatorie]
